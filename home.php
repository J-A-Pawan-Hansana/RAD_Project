...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            <span>upto 25% off</span>
            <span><h3>latest</h3> </span>
            <span><h3>smart watches</h3></span>
            <a href="shop.php" class="btn">shop now</a>
         </div>
      </div>
...
<section class="category">
   ...
   <a href="category.php?category=head set" class="swiper-slide slide">
